...
tellraw @s ""
tellraw @s [{text: "[", color: "white"}, {text: "TMS", color: "dark_aqua"}, {text: "] "}, {text: "> ", color: "yellow"}, {text: "coords", color: "gray"}, {text: ": ", color: "yellow"}, {text: "X="}, {"score": {name: "$cwm_pos-x", objective: "tms.var"}, color: "gold"}, "  ", {text: "Y="}, {"score": {name: "$cwm_pos-y", objective: "tms.var"}, color: "gold"}, "  ", {text: "Z="}, {"score": {name: "$cwm_pos-z", objective: "tms.var"}, color: "gold"}]
