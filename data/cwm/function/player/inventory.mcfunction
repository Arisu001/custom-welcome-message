...
execute if score $cm-open tms.var matches 1 unless data storage cwm:inventory {languages: 1b} run item replace entity @s hotbar.0 with tripwire_hook[custom_data={languages: 1b, cwm: 1b}] 1
...
execute if score $cm-open tms.var matches 1 unless data storage cwm:inventory {help: 1b} run item replace entity @s hotbar.2 with writable_book[custom_data={help: 1b, cwm: 1b}] 1
...
execute store result score $nb_cm-open tms.var run clear @s #cwm:settings[custom_data={custom_message: {open: 1b}, cwm: 1b}] 0
execute if score $cm-close tms.var matches 0 unless data storage cwm:inventory {custom_message: {open: 1b}} run item replace entity @s hotbar.4 with blaze_rod[custom_data={custom_message: {open: 1b}, cwm: 1b}] 1
execute if score $nb_cm-open tms.var matches 2.. run clear @s #cwm:settings[custom_data={custom_message: {open: 1b}, cwm: 1b}]
execute if score $cm-close tms.var matches 0 run item modify entity @s hotbar.4 cwm:settings/open
...
execute store result score $nb_cm-close tms.var run clear @s #cwm:settings[custom_data={custom_message: {close: 1b}, cwm: 1b}] 0
execute if score $cm-open tms.var matches 0 unless data storage cwm:inventory {custom_message: {close: 1b}} run item replace entity @s hotbar.4 with breeze_rod[custom_data={custom_message: {close: 1b}, cwm: 1b}] 1
execute if score $nb_cm-close tms.var matches 2.. run clear @s #cwm:settings[custom_data={custom_message: {close: 1b}, cwm: 1b}]
execute if score $cm-open tms.var matches 0 run item modify entity @s hotbar.4 cwm:settings/close
...
# Open and close
execute if score $cm-close tms.var matches 1 run function cwm:player/inventory/main_settings
execute if score $cm-open tms.var matches 1 run function cwm:player/inventory/init
